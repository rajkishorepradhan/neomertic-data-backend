...
# Add upstream remote
$ git remote add upstream https://github.com/NeoPhyte-live/<Repo-Name>.git
...
# fix - Bug fixes; code refactors;
# exp - Experimental; random experiemntal features;
# junk - Random code, not to be used, junk;
```
...
- Always follow [Conventional Commits Standard](https://www.conventionalcommits.org/en/v1.0.0/) and [Commitlint Conventional Rules](https://github.com/conventional-changelog/commitlint/tree/master/%40commitlint/config-conventional)
